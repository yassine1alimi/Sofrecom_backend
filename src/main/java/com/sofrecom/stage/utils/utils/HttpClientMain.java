package com.sofrecom.stage.utils.utils;
...
public class HttpClientMain {
 ...
 ;
    ...
    public String getPostCategory() throws JSONException{
        JSONArray jsonarray = new JSONArray(responseContent.toString());
    ...
    public JSONArray getJsonData(String responseContent) throws JSONException{
