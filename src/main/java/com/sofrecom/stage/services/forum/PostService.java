...
import com.sofrecom.stage.utils.utils.HttpClientMain;
import com.sofrecom.stage.utils.utils.PosthttpClient;
...
public class PostService implements IPostService {
    ...
    @Override
    public Post saveVideoFile(Long userId, MultipartFile file, Post postDetails) {
        try{
            Post post = new Post();
            post.setPostTitle(postDetails.getPostTitle());
            post.setPostDescription(postDetails.getPostDescription());
